        ...
        <div className="flex-1 flex flex-col items-center text-center gap-4 sm:gap-5 w-full">
          ...
          <div className="flex items-center gap-5 mt-4">
            ...
            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hover:opacity-70 transition-opacity">
              <svg width="20" height="24" viewBox="0 0 24 24" fill={colors.primary}>
...
function MapAndVideos() {
  ...
  return (
    <section className="w-full">
      {/* Google Maps Embed */}
      <div className="w-full h-[300px] sm:h-[380px] md:h-[420px] lg:h-[480px]">
        <div className="w-full h-full bg-gray-200 flex items-center justify-center">
          <div className="text-center px-4">
            ...
            <p className="text-xs text-gray-400 mt-1">Astsankhlam Holistic Wellness</p>
          </div>
        </div>
      </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[90vh]">
        ...
        <div className="relative min-h-[40vh] sm:min-h-[50vh] lg:min-h-full overflow-hidden">
          ...
          <div className="relative z-10 flex h-full items-center justify-center p-6 sm:p-8 lg:justify-end lg:pr-0">
            <div className="w-[85%] sm:w-[80%] max-w-[480px] translate-y-0 lg:translate-x-[15%] relative aspect-[4/5] overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] rounded-tr-none shadow-2xl">
              <Image
                src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1000&q=80"
                alt="Astsankhlam team and community"
                fill
