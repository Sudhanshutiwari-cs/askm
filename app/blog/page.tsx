                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-xs font-semibold uppercase tracking-wider mb-4" style={{ color: colors.primary }}>
                      ...
                      <span className="flex items-center gap-1 font-normal tracking-normal" style={{ color: colors.mutedForeground }}>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center" style={{ backgroundColor: colors.primary }}>
        <div className="mx-auto max-w-3xl text-white">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link
              href="/book"
              className="rounded-lg px-8 py-3.5 text-sm font-semibold tracking-wide transition-opacity hover:opacity-90 w-full sm:w-auto"
            ...
            <Link
              href="/services"
              className="rounded-lg px-8 py-3.5 text-sm font-semibold tracking-wide border border-white/40 transition-colors hover:bg-white/10 w-full sm:w-auto"
            >
